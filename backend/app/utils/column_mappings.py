...
#         "subject_id": ["Subject ID", "Subject"],
#         "subject_status": ["Subject Status (Source: PRIMARY Form)", "Subject Status"],
#         "missing_visits": ["Missing Visits", "# Missing Visits"],
#         "missing_pages": ["Missing Page", "Missing Pages", "# Missing Pages"],
#         "open_queries": ["#Total Queries", "Total Queries", "# Total Queries"],
#         "clean_crf_percent": ["% Clean Entered CRF"],
#         "protocol_deviations": ["Protocol Deviations (Source:(Rave EDC : BO4))", "Protocol Deviations"],
...
#     # 3. SDV (Fixed: Mapped "Subject Name" and "Data Page Name")
#     "raw_sdv_metrics": {
#         "site_id": ["Site", "Site ID"],
#         "subject_id": ["Subject Name", "Subject"],
#         "visit_date": ["Visit Date", "Visit date"],
#         "form_name": ["Data Page Name", "Form Name"],
#         "verification_status": ["Verification Status"]
#     },

#     # 4. MISSING PAGES (Fixed: Mapped "Page Name" and "# of Days Missing")
#     "raw_missing_pages": {
#         "subject_id": ["Subject Name", "SubjectName", "Subject"],
#         "site_id": ["Site Number", "SiteNumber", "Site"],
#         "form_name": ["Page Name", "FormName"],
#         "days_missing": ["# of Days Missing", "No. #Days Page Missing"]
#     },

#     # 5. WHODRUG (Fixed: ensured trade_name maps correctly)
#     "raw_coding_whodra": {
#         "subject_id": ["Subject"],
#         "coding_status": ["Coding Status"],
#         "trade_name": ["Trade Name", "Trade name"]
#     },

#     # 6. SAE / SAFETY
#     "raw_sae_safety": {
#         "subject_id": ["Patient ID", "Subject"],
#         "site_id": ["Site"],
...
#     # 8. LAB ISSUES
#     "raw_lab_issues": {
#         "site_id": ["Site number", "Site"],
#         "subject_id": ["Subject"],
#         "visit": ["Visit"],
#         "lab_category": ["Lab category"],
#         "test_name": ["Test Name", "Test description"],
#         "issue_type": ["Issue"]
#     },
...
#         "days_outstanding": ["# Days Outstanding", "# Days Outstanding (TODAY - PROJECTED DATE)"]
#     },
...
#         "subject_id": ["Subject"],
#         "site_id": ["Site"],
#         "issue_count": ["Total Open issue Count per subject", "Total Open issue Count"]
#     },

#     # 11. INACTIVATED FORMS
#     "raw_inactivated_forms": {
#         "subject_id": ["Subject"],
#         "site_id": ["Study Site Number", "Site"],
#         "folder_name": ["Folder"],
#         "form_name": ["Form"],
