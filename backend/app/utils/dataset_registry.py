...
DATASET_SPECS = {
    "raw_cpid_metrics": {
        # Check for Subject ID AND at least one key metric to confirm identity
        "required_columns": ["subject_id", "missing_pages"], 
        "table": "raw_cpid_metrics",
        "optional_columns": ["missing_visits", "open_queries", "protocol_deviations"]
    },
    "raw_missing_pages": {
        "required_columns": ["form_name", "days_missing"],
        "table": "raw_missing_pages"
    },
    "raw_protocol_deviations": {
        "required_columns": ["pd_status"],
        "table": "raw_protocol_deviations"
    },
    "raw_visit_projections": {
        "required_columns": ["projected_date", "days_outstanding"],
    ...
    "raw_inactivated_forms": {
        "required_columns": ["audit_action", "form_name"],
        "table": "raw_inactivated_forms"
    },
    "raw_edrr_issues": {
        "required_columns": ["issue_count"], 
