...
import { 
  ...
  Bell, AlertTriangle, XCircle, BrainCircuit
} from 'lucide-react';
...
// --- LOAD STUDIES ---
  ...
  const fetchData = async () => {
    ...
    try {
      ...
      // MAPPING UPDATE: The backend now returns { study_health, top_risky_sites }
      ...
      >
        ...
        <AppShell.Navbar p="md">
            ...
            {userRole === 'Lead' && (
                 <>
<NavLink 
        icon={LayoutDashboard} // Or import LayoutGrid from lucide-react
    ...
    <NavLink 
        icon={Activity} // Changed icon to distinguish from Portfolio
